		...
		// A completar por el alumno : desde aquí
		 try {
		        ...
		        if (!rs.next()) {
		            ...
		            throw new SQLException("No existe el viaje especificado.", null, CompraBilleteTrenException.NO_EXISTE_VIAJE);
		        }
		        ...
		        if (!rs.next() || rs.getInt("plazas_disponibles") < nroPlazas) {
		            ...
		            throw new SQLException("No hay plazas disponibles para el viaje especificado.", null,CompraBilleteTrenException.NO_PLAZAS);
		        }
